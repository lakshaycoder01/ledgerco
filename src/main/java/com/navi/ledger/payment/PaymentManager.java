...
public class PaymentManager implements CommandExecution {
    ...
    public void instanceExecute() {
        ...
        paymentExecution(bankName, customerName, lumSumAmount, afterEmiCount);
    }

    private void paymentExecution(String bankName, String customerName, double lumSumAmount, int afterEmiCount) {
        Map<String, Loan> bankLoanMap = Util.userLoanMapping().get(customerName);
        ...
        Util.userLoanMapping().get(customerName).put(bankName, customerLoan);
    }
